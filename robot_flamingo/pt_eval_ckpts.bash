...
export DISPLAY=:99
export PYTHONPATH=/mnt/dolphinfs/hdd_pool/docker/user/hadoop-vacv/yanfeng/project/robotic/RoboFlamingo2
export EVALUTION_ROOT=$(pwd)

# !!! Set for your own path
calvin_dataset_path='/mnt/dolphinfs/hdd_pool/docker/user/hadoop-vacv/yanfeng/data/robotics/task_D_D/'
# calvin_conf_path
calvin_conf_path="/mnt/dolphinfs/hdd_pool/docker/user/hadoop-vacv/yanfeng/project/robotic/calvin/calvin_models/conf"
# language model path
lm_path='/mnt/dolphinfs/hdd_pool/docker/user/hadoop-vacv/yanfeng/project/robotic/RoboFlamingo/checkpoints/mpt-1b-redpajama-200b-dolly'
# tokenizer path
